...
onMounted(async () => {
  try {
    ...
    console.error('Failed to fetch my sale cards', error)
  } finally {
...
<template>
  <div class="orders-page container">
    ...
    <section v-else-if="listings && listings.length > 0" class="orders-list">
...
.status-badge.sold { background: #e0f2fe; color: #0c4a6e; }
.status-badge.hidden { background: #f1f5f9; color: #475569; }
